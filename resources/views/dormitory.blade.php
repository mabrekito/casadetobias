...
<h2 style="text-align:center">Clubhouse Dormitory</h2>
...
<div class="row">
  <div class="column">
    <img src="images/dormitory/dormitory1.jpg" style="width:100%" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/dormitory/dormitory2.jpg" style="width:100%" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/dormitory/dormitory3.jpg" style="width:100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/dormitory/dormitory4.jpg" style="width:100%" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
  </div>
</div>
</div>
</div>
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="images/dormitory/dormitory1.jpg" style="width:100%">
    </div>

    <div class="mySlides">
      <div class="numbertext">2 / 4</div>
      <img src="images/dormitory/dormitory2.jpg" style="width:100%">
    </div>

    <div class="mySlides">
      <div class="numbertext">3 / 4</div>
      <img src="images/dormitory/dormitory3.jpg" style="width:100%">
    </div>

    <div class="mySlides">
      <div class="numbertext">4 / 4</div>
      <img src="images/dormitory/dormitory4.jpg" style="width:100%">
    </div>
...
<div class="row">
    <div class="col-sm-3 p-4">
      <img class="demo cursor" src="images/dormitory/dormitory1.jpg" style="width:80%" onclick="currentSlide(1)" alt="dormitory1">
    </div>
    <div class="col-sm-3 p-4">
      <img class="demo cursor" src="images/dormitory/dormitory2.jpg" style="width:80%" onclick="currentSlide(2)" alt="dormitory2">
    </div>
    <div class="col-sm-3 p-4">
      <img class="demo cursor" src="images/dormitory/dormitory3.jpg" style="width:80%" onclick="currentSlide(3)" alt="dormitory3">
    </div>
    <div class="col-sm-3 p-4">
      <img class="demo cursor" src="images/dormitory/dormitory4.jpg" style="width:80%" onclick="currentSlide(4)" alt="dormitory4">
    </div>
  </div>
</div>
</div>
...
<div class="main-content">
  <div class="container">
    <div class="row">
      <div class="col-lg-8">
        <h1>About Clubhouse Dormitory</h1>

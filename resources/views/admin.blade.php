...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo" style="background-color:white">
            ...
            <span class="logo-lg"><img src="/images/mini-logo.jpg" width="25%"></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/images/mini-logo.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">Alexander Pierce</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/images/mini-logo.jpg" class="img-circle" alt="User Image">
        ...
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                  <li>
                      <a href="/admin">
                          <i class="fa fa-book"></i> <span>Room Booking</span>
